...
const translations = {
  pt: {
    ...
    'testi.q1': 'Trabalhar com o Yuri foi uma experiência excelente. Ele desenvolveu o site da nossa empresa com muita atenção aos detalhes, profissionalismo e agilidade na comunicação. Mesmo trabalhando remotamente, sempre esteve disponível para ajustes e dúvidas. Entregou um resultado que superou nossas expectativas, entendendo exatamente o que precisávamos para representar bem o nosso negócio online. Recomendo fortemente o trabalho dele pelo profissionalismo e pela busca da satisfação do cliente.',
    'testi.r1': 'ACES Electrical Services · EUA',
    'testi.q2': 'Trabalhar com o Yuri foi tranquilo do início ao fim. Ele entendeu minha visão rápido, entregou no prazo e ainda trouxe sugestões que deixaram o site melhor do que eu tinha imaginado, além de ajustar os parâmetros técnicos pra deixar tudo funcionando direitinho. Comunicação clara, atenção aos detalhes e um resultado impecável. Recomendo sem pensar duas vezes.',
    'testi.r2': 'Mentoria Route',
    'testi.q3': 'O Yuri sempre nos atendeu com muita proatividade e, desde o primeiro contato, entendeu com facilidade o que a Hidro-Sul queria transmitir com o nosso site. Depois que o site foi lançado, recebemos muitos elogios pelo layout e pela forma como a empresa passou a ser apresentada. Ficamos muito satisfeitos com o resultado e, sem dúvida, foi um projeto que agregou muito valor à imagem da Hidro-Sul.',
    'testi.r3': 'Hidro-Sul',
  ...
  en: {
    ...
    'testi.q1': "Working with Yuri was an excellent experience. He built our company website with great attention to detail, professionalism and quick communication. Even working remotely, he was always available for adjustments and questions. He delivered a result that exceeded our expectations, understanding exactly what we needed to represent our business well online. I strongly recommend his work for his professionalism and his commitment to client satisfaction.",
    'testi.r1': 'ACES Electrical Services · USA',
    'testi.q2': "Working with Yuri was smooth from start to finish. He understood my vision quickly, delivered on time and brought suggestions that made the site better than I had imagined, on top of fine-tuning the technical settings so everything ran smoothly. Clear communication, attention to detail and an impeccable result. I'd recommend him without thinking twice.",
    'testi.r2': 'Mentoria Route',
    'testi.q3': "Yuri always worked with us very proactively and, from the very first contact, easily grasped what Hidro-Sul wanted to convey with our site. After the site launched, we received a lot of compliments on the layout and on how the company is now presented. We were very happy with the result and, without a doubt, it was a project that added a lot of value to Hidro-Sul's image.",
    'testi.r3': 'Hidro-Sul',
